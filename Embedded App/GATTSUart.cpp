...
#define LINKIT_PHONE "+33781038271"
...
static LGATTServiceInfo g_uart_decl[] = {
    ...
    {TYPE_SERVICE, "aaaaaaaa-ab95-444d-bac8-c04f2dcf8d6e", TRUE, 0, 0, 0},
    //Declaration of the transmission characteristic for periphral
    {TYPE_CHARACTERISTIC, "00003a26-89a6-4e7b-b96c-83612b7702f2", FALSE,
    ...
    {TYPE_CHARACTERISTIC, "11113a26-89a6-4e7b-b96c-83612b7702f3", FALSE,
...
boolean GATTSUart::onWrite(LGATTWriteRequest &data)
{
    ...
    if (_connected)
    {
        ...
        memcpy(contact, data.value.value, data.value.len);
